...
function validaExp () {   
  // limitar hora y cambiar precio para hoy
   if (servExp.value == fechaC) {
         if (hora >= 15 ){
               document.getElementById('hora').innerHTML='<option value="";>Hoy ya no hay citas disponibles</option>'
          } else if ( hora > 14){
           document.getElementById('hora').innerHTML =  "<option selected>Horario</option><option>5:00 pm</option>";
         }  else if (hora > 13){
            document.getElementById('hora').innerHTML =  "<option selected>Horario</option><option >4:00 pm</option><option>5:00 pm</option>";
         }  else if (hora > 12 ){
            document.getElementById('hora').innerHTML =  "<option selected>Horario</option><option >3:00 pm</option><option >4:00 pm</option><option>5:00 pm</option>";
           }
           else if (hora >11 ){
            document.getElementById('hora').innerHTML =  "<option selected>Horario</option><option >2:00 pm</option><option >3:00 pm</option><option >4:00 pm</option><option>5:00 pm</option>";
           }
           else if (hora > 10 ){
            document.getElementById('hora').innerHTML =  "<option selected>Horario</option><option >1:00 pm</option><option >2:00 pm</option><option >3:00 pm</option><option >4:00 pm</option><option>5:00 pm</option>";
           }
           else if (hora > 9 ){
            document.getElementById('hora').innerHTML =  "<option selected>Horario</option><option >12:00 pm</option><option >1:00 pm</option><option >2:00 pm</option><option >3:00 pm</option><option >4:00 pm</option><option>5:00 pm</option>";
           }
           else if (hora > 8 ){
            document.getElementById('hora').innerHTML =  "<option selected>Horario</option><option >11:00 am</option><option >12:00 pm</option><option >1:00 pm</option><option >2:00 pm</option><option >3:00 pm</option><option >4:00 pm</option><option>5:00 pm</option>";
           }
           else if (hora > 7 ){
            document.getElementById('hora').innerHTML =  "<option selected>Horario</option><option >10:00 am</option><option >11:00 am</option><option >12:00 pm</option><option >1:00 pm</option><option >2:00 pm</option><option >3:00 pm</option><option >4:00 pm</option><option>5:00 pm</option>";
           }
          
           else if  (hora > 6 ){
            document.getElementById('hora').innerHTML =  "<option selected>Horario</option><option >9:00 am</option><option >10:00 am</option><option >11:00 am</option><option >12:00 pm</option><option >1:00 pm</option><option >2:00 pm</option><option >3:00 pm</option><option >4:00 pm</option><option>5:00 pm</option>";
           }
